...
view(df)
#then plot bat activity in relation to rain activity
df<-df%>% 
...
ggplot()+
  ...
  geom_line(data=df, aes(x=Month, y=total_monthly_rainfall, color=AUTO.ID))+
  facet_wrap(~Year, scales="free") +
  scale_x_continuous( breaks = 1:12)

  
#two plots on top of each other
  #vertical line that indicates the amount of rainfall 
  #vertical lines just at the top? 
  #geom segment or vline 
...
#plot max temp and bat activity by species 
...
```{r}
#look at humidity levels and how it affects specific species 
#is solar total humidity? 
